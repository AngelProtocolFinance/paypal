    ...
    schemas: {
        ...
        "authorizations.reauthorize-422": {
            details?: ({
                ...
                /** @enum {string} */
                issue?: "REAUTHORIZATION_DECLINED_BY_PROCESSOR";
                /** @enum {string} */
                description?: "The reauthorization was declined by the processor.";
            } | {
                /** @enum {string} */
                issue?: "REAUTHORIZATION_NOT_SUPPORTED_FOR_PAYMENT_SOURCE";
                /** @enum {string} */
         ...
         * @enum {string}
         */
        card_brand: "VISA" | "MASTERCARD" | "DISCOVER" | "AMEX" | "SOLO" | "JCB" | "STAR" | "DELTA" | "SWITCH" | "MAESTRO" | "CB_NATIONALE" | "CONFIGOGA" | "CONFIDIS" | "ELECTRON" | "CETELEM" | "CHINA_UNION_PAY" | "DINERS" | "ELO" | "HIPER" | "HIPERCARD" | "RUPAY" | "GE" | "SYNCHRONY" | "EFTPOS" | "UNKNOWN";
        ...
        "definitions-platform_fee_list": components["schemas"]["definitions-platform_fee"][];
        /**
         * Disbursement Mode
         ...
         */
        payment_instruction: {
            platform_fees?: components["schemas"]["payment_instruction_definition_platform_fee_list"];
        ...
        payment_instruction_definition_platform_fee_list: components["schemas"]["platform_fee"][];
        /**
         * Platform Fee
         * @description The platform or partner fee, commission, or brokerage fee that is associated with the transaction. Not a separate or isolated transaction leg from the external perspective. The platform fee is limited in scope and is always associated with the original payment for the purchase unit.
         */
