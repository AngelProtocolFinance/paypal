    ...
    schemas: {
        ...
        422: {
            details?: ({
                ...
                /** @enum {string} */
                issue?: "INVALID_POSTAL_CODE";
                /** @enum {string} */
                description?: "For vaulting with purchase, postal code (billing_address.postal_code) can only contain letters, numbers, spaces, and hyphens";
            } | {
                /** @enum {string} */
                issue?: "INVALID_POSTAL_CODE_LENGTH";
                /** @enum {string} */
                description?: "For vaulting with purchase, postal code (billing_address.postal_code) may contain no more than 9 letter or number characters";
            } | {
                /** @enum {string} */
                issue?: "BILLING_AGREEMENTS_CANNOT_BE_USED_FOR_SUBSCRIPTIONS";
                /** @enum {string} */
                description?: "Billing Agreements cannot be used for Subscription orders.";
            } | {
                /** @enum {string} */
                ...
                /** @enum {string} */
                description?: "Different `shipping.type` are not supported across purchase units nor within an individual item's shipping options.";
            } | {
                /** @enum {string} */
                ...
                /** @enum {string} */
                issue?: "PAYMENT_ORIGIN_NOT_ENABLED";
                /** @enum {string} */
                description?: "The API caller account or payee is not enabled for the given 'payment_origin' option. Please contact customer support for assistance.";
            } | {
                /** @enum {string} */
                ...
                /** @enum {string} */
                issue?: "UNSUPPORTED_PAYMENT_SOURCE_FOR_SUBSCRIPTIONS";
                /** @enum {string} */
                description?: "The specified payment source is not supported for subscriptions. Only a `vault_id` or `vault_setup_token` with `payment_source.card` and `payment_source.paypal` are supported.";
            } | {
                /** @enum {string} */
                ...
                /** @enum {string} */
                description?: "`intent=AUTHORIZE` is not supported for this operation. Only `intent=CAPTURE` is supported.";
            } | {
                /** @enum {string} */
                issue?: "UNSUPPORTED_INTENT_FOR_KYC_INCOMPLETE_PAYEE";
                /** @enum {string} */
                description?: "`intent=AUTHORIZE` is not supported due to payee's incomplete KYC, while their partner is enabled for Progressive Onboarding. Only `intent=CAPTURE` is supported.";
            } | {
                /** @enum {string} */
                ...
                /** @enum {string} */
                description?: "The API Caller account is not setup to be able to support a `shipping.type`=`PICKUP_IN_PERSON`. This feature is only supported for <a href=\"https://www.paypal.com/us/business/platforms-and-marketplaces\">PayPal Complete Payments Platform for Platforms and Marketplaces</a>.";
            } | {
                /** @enum {string} */
                ...
                /** @enum {string} */
                issue?: "INVALID_SHIPPING_OPTION_ID";
                /** @enum {string} */
                description?: "The items.shipping.options_ids[].id does not exist in purchase_units.shipping.options[]. Please ensure that all ids used in options_ids are first defined in purchase_units.shipping.options[].";
            } | {
                /** @enum {string} */
                issue?: "INVALID_DELIVERY_ESTIMATE";
                /** @enum {string} */
                description?: "The provided `delivery_time_max` must be greater than the `delivery_time_min`, and vice versa.";
            } | {
                /** @enum {string} */
                issue?: "INELIGIBLE_SHIPPING_OPTION";
                /** @enum {string} */
                description?: "One or more shipping options cannot be used in conjunction with this Order.";
            } | {
                /** @enum {string} */
                issue?: "MISSING_SHIPPING_CALL_BACK_CONFIGURATION";
                /** @enum {string} */
                description?: "`payment_source.paypal.experience_context.order_update_callback_config` is mandatory for one or more shipping.options provided in the request.";
            } | {
                /** @enum {string} */
                issue?: "MISSING_ITEM_SHIPPING_OPTIONS";
                /** @enum {string} */
                description?: "All items in the purchase_unit must have `options_ids` defined if any item in the Order has `item[].shipping.options_ids` defined.";
            } | {
                /** @enum {string} */
                ...
                /** @enum {string} */
                issue?: "MISMATCHED_VAULT_OWNER_ID";
                /** @enum {string} */
                description?: "The owner_id does not match with the API caller. Please verify that the owner_id is same as the API caller's payer id.";
            } | {
                /** @enum {string} */
                issue?: "VAULT_OWNER_ID_NOT_SUPPORTED";
                /** @enum {string} */
                description?: "API caller is not enabled to specify the vault owner_id explicitly. Please contact your account manager to enable the functionality.";
            } | {
                /** @enum {string} */
                ...
                /** @enum {string} */
                issue?: "MISMATCHED_VAULT_SETUP_TOKEN_TO_PAYMENT_SOURCE";
                /** @enum {string} */
                description?: "The `vault_setup_token` does not match the payment_source provided. Please verify that the `vault_setup_token` token used refers to the matching payment_source and try again. For example, a PayPal token cannot be passed in the `vault_setup_token` field in the `payment_source.card` object.";
            } | {
                /** @enum {string} */
                ...
                /** @enum {string} */
                issue?: "PREFERRED_BRAND_NOT_SUPPORTED";
                /** @enum {string} */
                description?: "Processing of this preferred brand is not supported. Please use another brand preference to continue with this transaction.";
            } | {
                /** @enum {string} */
                ...
                /** @enum {string} */
                issue?: "INCOMPATIBLE_ACCOUNT_OWNERSHIP_TYPE";
                /** @enum {string} */
                description?: "Account ownership type is not compatible with standard entry class code.";
            } | {
                /** @enum {string} */
                issue?: "DELAYED_DISBURSEMENT_NOT_SUPPORTED";
                /** @enum {string} */
                description?: "The API Caller is not enabled to process transactions by specifying disbursement mode as delayed.";
            } | {
                /** @enum {string} */
                issue?: "DELAYED_DISBURSEMENT_NOT_SUPPORTED_FOR_KYC_INCOMPLETE_PAYEE";
                /** @enum {string} */
                description?: "The Delayed disbursement is not supported due to payee's incomplete KYC, while their partner is enabled for Progressive Onboarding.";
            } | {
                /** @enum {string} */
                issue?: "PARTNER_SETTLEMENT_NOT_SUPPORTED_FOR_KYC_INCOMPLETE_PAYEE";
                /** @enum {string} */
                description?: "Partner settlement is not supported due to payee's incomplete KYC, while their partner is enabled for Progressive Onboarding.";
            } | {
                /** @enum {string} */
                ...
                /** @enum {string} */
                issue?: "INVALID_VAULT_ID";
                /** @enum {string} */
                description?: "The specified Vault ID is invalid or could not be found.";
            } | {
                /** @enum {string} */
                issue?: "MULTIPLE_PURCHASE_UNITS_NOT_SUPPORTED_FOR_PAYMENT_SOURCE";
                /** @enum {string} */
                description?: "The provided payment source cannot be used to pay for the multiple purchase units order.";
            } | {
                /** @enum {string} */
                ...
                /** @enum {string} */
                issue?: "LOCALE_NOT_SUPPORTED_BY_PAYMENT_SOURCE";
                /** @enum {string} */
                description?: "Locale provided is not supported by the provided payment source.";
            } | {
                /** @enum {string} */
                issue?: "BANK_VERIFICATION_REQUIRED";
                /** @enum {string} */
                description?: "Only verified bank accounts can be processed.";
            } | {
                /** @enum {string} */
                ...
                /** @enum {string} */
                issue?: "MISSING_REQUIRED_PARAMETER_FOR_BILLING_PLAN";
                /** @enum {string} */
                description?: "PayPal Vault billing plan requires usage_pattern to be passed in the request. Supported Values: SUBSCRIPTION, UNSCHEDULED, RECURRING, INSTALLMENT (prepaid/postpaid)";
            } | {
                /** @enum {string} */
                issue?: "UNSUPPORTED_INTEGRATION_FOR_BILLING_PLAN";
                /** @enum {string} */
                description?: "For Recurring Purchases, passing billing plan and vaulting instruction (in payment_source.paypal.attributes.vault or payment_source.paypal.billing) is mandatory. Also, only one billing plan, product and purchase unit are supported.";
            } | {
                /** @enum {string} */
                issue?: "INCOMPATIBLE_PARAMETER_FOR_BILLING_PLAN";
                /** @enum {string} */
                description?: "For Recurring Purchase, amount fields like handling, insurance, discount and shipping discount are unsupported.";
            } | {
                /** @enum {string} */
                issue?: "BILLING_ITEM_AMOUNT_MISMATCH";
                /** @enum {string} */
                description?: "For Recurring Purchases, the billing plan’s unit amount should include both the setup fee and the plan price (only if the plan starts immediately, i.e. no start_date).";
            })[];
        };
        /**
        ...
        /**
         * ApplePay payment response object
        ...
        apple_pay: {
            ...
            card?: components["schemas"]["apple_pay_card_response"];
            /** @description Additional attributes associated with apple pay. */
            attributes?: components["schemas"]["apple_pay_attributes_response"];
        ...
        authorization: components["schemas"]["authorization_status"] & {
            ...
            links?: components["schemas"]["authorization_definitions-link_description_list"];
        ...
        "authorization_definitions-link_description_list": components["schemas"]["link_description"][];
        /**
        ...
        authorization_with_additional_data_list: components["schemas"]["authorization_with_additional_data"][];
        /**
        ...
        billing_cycle: {
            ...
            start_date?: components["schemas"]["date_no_time"];
        };
        ...
        callback_configuration: {
            callback_events: components["schemas"]["callback_events_list"];
            /**
             * Format: uri
        ...
        callback_events_list: components["schemas"]["callback_events"][];
        /**
         * Capture
        ...
        capture: components["schemas"]["capture_status"] & {
            ...
            links?: components["schemas"]["capture_definitions-link_description_list"];
        ...
        card_request: {
            ...
            single_use_token?: components["schemas"]["single_use_token"];
            stored_credential?: components["schemas"]["card_stored_credential"];
         ...
         */
        cobranded_card: {
            labels?: components["schemas"]["labels_list"];
            /**
             * Payee Base
        ...
        cobranded_card_list: components["schemas"]["cobranded_card"][];
        /**
        ...
        "definitions-platform_fee_list": components["schemas"]["platform_fee"][];
        ...
        "definitions-purchase_unit_request_list": components["schemas"]["purchase_unit_request"][];
        /** @description An array of shipping options that the payee or merchant offers to the payer to ship or pick up their items. */
        "definitions-shipping_option_list": components["schemas"]["shipping_option"][];
        /**
         * Disbursement Mode
        ...
        dispute_categories_list: components["schemas"]["dispute_categories"][];
        /**
        ...
        experience_context_swish: {
             ...
             */
            return_intent_url?: components["schemas"]["url"];
        };
        frequency: unknown;
        ...
        google_pay: {
            ...
            card?: components["schemas"]["google_pay_card_response"];
        };
        google_pay_attributes: unknown;
        /**
        ...
        google_pay_request: {
            ...
            decrypted_token?: components["schemas"]["google_pay_decrypted_token_data"];
            /** @description Information about what validation has been performed on the returned payment credentials. */
            assurance_details?: components["schemas"]["assurance_details"];
            attributes?: components["schemas"]["google_pay_attributes"];
        ...
        labels_list: components["schemas"]["labels"][];
        /**
        ...
        level_3_card_processing_data: {
            ...
            line_items?: components["schemas"]["line_item_list"];
        };
        /**
        ...
        line_item_list: components["schemas"]["line_item"][];
        /**
         * Link Description
         * @description The request-related [HATEOAS link](/api/rest/responses/#hateoas-links) information.
         */
        ...
        most_recent_error: unknown;
        /** @description The error reason code and description that are the reason for the most recent order decline. */
        most_recent_error_list: components["schemas"]["most_recent_error"][];
        /**
        ...
        net_amount_breakdown_item_list: components["schemas"]["net_amount_breakdown_item"][];
        /**
         * Network Token
        ...
        order: components["schemas"]["activity_timestamps"] & {
            ...
            purchase_units?: components["schemas"]["purchase_unit_list"];
            readonly status?: components["schemas"]["order_status"];
            links?: components["schemas"]["order_definitions-link_description_list"];
        };
        /**
        ...
        order_authorize_response: components["schemas"]["activity_timestamps"] & unknown & {
            ...
            payment_source?: {
                ...
                swish?: components["schemas"]["swish"];
        ...
        "order_definitions-link_description_list": components["schemas"]["link_description"][];
        /**
         * Order Request
        ...
        order_request: {
             ...
             */
            payer?: components["schemas"]["payer"];
            purchase_units: components["schemas"]["purchase_unit_request_list"];
            payment_source?: components["schemas"]["payment_source"];
        ...
        order_tracker_request: {
            ...
            items?: components["schemas"]["tracker_item_list"];
        };
        /**
        ...
        order_update_callback_request: {
            ...
            purchase_units: components["schemas"]["definitions-purchase_unit_request_list"];
        };
        /**
        ...
        order_update_callback_response: {
            /** @description The ID of the order. */
            readonly id?: string;
            purchase_units?: components["schemas"]["shipping_options_purchase_unit"];
        };
        ...
        "orders.authorize-422": {
            details?: ({
                ...
                /** @enum {string} */
                issue?: "CARD_COUNTRY_NOT_SUPPORTED";
                /** @enum {string} */
                description?: "The country in which this card was issued is not currently supported. Please use another card to continue with this transaction.";
            } | {
                /** @enum {string} */
                issue?: "CARD_DATA_NOT_FOUND";
                /** @enum {string} */
                description?: "The card issuer data information could not be retrieved. Please use a different card to proceed with this transaction.";
            } | {
                /** @enum {string} */
                ...
                /** @enum {string} */
                issue?: "CONTINGENCY_NOT_SUCCESSFUL";
                /** @enum {string} */
                description?: "3D-Secure payer authentication is unsuccessful, so the payment cannot be completed.";
            } | {
                /** @enum {string} */
                issue?: "PAYEE_FX_RATE_ID_EXPIRED";
                /** @enum {string} */
                ...
                issue?: "VAULT_OWNER_ID_NOT_SUPPORTED";
                /** @enum {string} */
                description?: "API caller is not enabled to specify the vault owner_id explicitly. Please contact account manager to enable the functionality.";
            } | {
                /** @enum {string} */
                issue?: "MISMATCHED_VAULT_ID_TO_PAYMENT_SOURCE";
                /** @enum {string} */
                ...
                /** @enum {string} */
                description?: "The API caller account is setup in a way that does not allow it to be used for saving the order. This functionality is not available for PayPal Complete Payments Platform for Platforms & Marketplaces.";
            } | {
                /** @enum {string} */
                issue?: "NOT_ELIGIBLE_FOR_PNREF_PROCESSING";
                /** @enum {string} */
                ...
                /** @enum {string} */
                issue?: "ORDER_AUTHORIZATION_IN_PROGRESS";
                /** @enum {string} */
                description?: "The `processing_instruction` sent with the selected `payment_source` was `ORDER_COMPLETE_ON_PAYMENT_APPROVAL`, resulting in auto-authorization. Merchant initiated authorization is not allowed.";
            })[];
        };
        "orders.capture-400": {
            details?: ({
        ...
        "orders.capture-422": {
            details?: ({
                ...
                /** @enum {string} */
                issue?: "INVALID_VAULT_SETUP_TOKEN";
                /** @enum {string} */
                description?: "The specified Vault Setup Token is invalid or could not be found.";
            } | {
                /** @enum {string} */
                issue?: "INVALID_SECURITY_CODE_LENGTH";
                /** @enum {string} */
                ...
                /** @enum {string} */
                issue?: "AUTO_CAPTURE_ENABLED";
                /** @enum {string} */
                description?: "This order is being auto-captured. Merchant initiated capture requests are not allowed.";
            })[];
        };
        "orders.confirm-400": {
            details?: ({
        ...
        "orders.confirm-422": {
            details?: ({
                ...
                /** @enum {string} */
                issue?: "PUI_DUPLICATE_ORDER";
                /** @enum {string} */
                description?: "A Pay Upon Invoice (Rechnungskauf) order with the same payload has already been successfully processed in the last few seconds. To process a new order, please try again in a few seconds.";
            } | {
                /** @enum {string} */
                issue?: "NOT_ENABLED_FOR_PAYMENT_SOURCE";
                /** @enum {string} */
        ...
        "orders.patch-422": {
            details?: ({
                ...
                issue?: "SHIPPING_OPTIONS_NOT_SUPPORTED";
                /** @enum {string} */
                description?: "Shipping options are not supported when `shipping.type` is specified or when 'payment_source.paypal.experience_context.shipping_preference' is set as 'NO_SHIPPING' or 'SET_PROVIDED_ADDRESS'.";
            } | {
                /** @enum {string} */
                issue?: "MULTIPLE_SHIPPING_OPTION_SELECTED";
                /** @enum {string} */
                ...
                /** @enum {string} */
                issue?: "DUPLICATE_SHIPPING_OPTION_ID";
                /** @enum {string} */
                description?: "Please specify a unique shipping option id for each shipping option provided in the request and try again.";
            } | {
                /** @enum {string} */
                ...
                /** @enum {string} */
                issue?: "CANNOT_MODIFY_INTENT";
                /** @enum {string} */
                description?: "The value of 'intent' cannot be changed. Please create a new order.";
            } | {
                /** @enum {string} */
                issue?: "PREFERRED_SHIPPING_OPTION_AMOUNT_MISMATCH";
                /** @enum {string} */
        ...
        "orders.track.create-422": {
            details?: ({
                /** @enum {string} */
                issue?: "INVALID_TRACKING_NUMBER";
                /** @enum {string} */
                description?: "Use a valid tracking number. It must not be empty, contain spaces or tab characters";
            } | {
                /** @enum {string} */
        ...
        "orders.trackers.patch-422": {
            details?: ({
                ...
                /** @enum {string} */
                issue?: "MAX_TRACKER_UPDATE_COUNT_EXCEEDED";
                /** @enum {string} */
                description?: "Exceeding the permissible number of updates; tracker update operations do not support more than 15 updates.";
            })[];
        };
        /**
         * P24 payment object
        ...
        participant_metadata: {
            ...
            ip_address?: components["schemas"]["ip_address"];
        };
        /**
         * Patch
         ...
         */
        payment_collection: {
            authorizations?: components["schemas"]["authorization_with_additional_data_list"];
            captures?: components["schemas"]["capture_list"];
            refunds?: components["schemas"]["refund_list"];
        };
        /**
         ...
         */
        payment_instruction: {
            platform_fees?: components["schemas"]["platform_fee_list"];
        ...
        payment_source: {
            ...
            crypto?: components["schemas"]["crypto_request"];
        };
        /**
         * Payment Source Response
         * @description The payment source used to fund the payment.
        ...
        paypal_wallet_attributes_response: {
            ...
            cobranded_cards?: components["schemas"]["cobranded_card_list"];
        };
        /**
         * PayPal Wallet Customer Information
         * @description The details about a customer in PayPal's system of record.
         */
        ...
        paypal_wallet_experience_context: {
            ...
            order_update_callback_config?: components["schemas"]["callback_configuration"];
        };
        /**
        ...
        /**
         * PayPal Wallet stored credentials
        ...
        paypal_wallet_stored_credential: {
            ...
            /**
             * @deprecated
             * @description DEPRECATED. Expected business/pricing model for the billing agreement, Please use usage_pattern instead.
             */
            charge_pattern?: components["schemas"]["charge_pattern"];
        ...
        pix: {
            ...
            qr_details?: components["schemas"]["qr_details"];
        };
        /**
         * Pix payment object
         * @description Information needed to pay using Pix.
        ...
        platform_fee_list: components["schemas"]["platform_fee"][];
        /**
         * Pricing Scheme
        ...
        pricing_scheme: {
            ...
            reload_threshold_amount?: components["schemas"]["money"];
        };
        ...
        purchase_unit: {
            ...
            most_recent_errors?: components["schemas"]["most_recent_error_list"];
        };
        ...
        purchase_unit_list: components["schemas"]["purchase_unit"][];
        /**
        ...
        purchase_unit_request_list: components["schemas"]["purchase_unit_request"][];
        /**
         * QR Details
        ...
        refund: components["schemas"]["refund_status"] & {
            ...
            seller_payable_breakdown?: components["schemas"]["seller_payable_breakdown"];
            /** @description The details associated with the merchant for this transaction. */
            readonly payer?: components["schemas"]["payee_base"];
            links?: components["schemas"]["refund_definitions-link_description_list"];
        } & components["schemas"]["activity_timestamps"];
        /** @description An array of related [HATEOAS links](/docs/api/reference/api-responses/#hateoas-links). */
        "refund_definitions-link_description_list": components["schemas"]["link_description"][];
        /** @description An array of platform or partner fees, commissions, or brokerage fees for the refund. */
        "refund_definitions-platform_fee_list": components["schemas"]["platform_fee"][];
        /** @description An array of refunds for a purchase unit. A purchase unit can have zero or more refunds. */
        refund_list: components["schemas"]["refund"][];
        /**
        ...
        seller_payable_breakdown: {
            ...
            platform_fees?: components["schemas"]["refund_definitions-platform_fee_list"];
            net_amount_breakdown?: components["schemas"]["net_amount_breakdown_item_list"];
        ...
        seller_protection: {
            ...
            dispute_categories?: components["schemas"]["dispute_categories_list"];
        };
        /**
        ...
        seller_receivable_breakdown: {
            ...
            platform_fees?: components["schemas"]["definitions-platform_fee_list"];
        };
        /**
         * Carrier.
         ...
         * @description This would contain shipping option and amount data at purchase unit level.
         */
        shipping_options_purchase_unit: {
            ...
            amount?: components["schemas"]["amount_with_breakdown"];
            shipping_options?: components["schemas"]["definitions-shipping_option_list"];
        };
        /**
         * Shipping Type
         * @description A classification for the method of purchase fulfillment.
        ...
        shipping_with_tracking_details: components["schemas"]["shipping_detail"] & {
            trackers?: components["schemas"]["tracker_list"];
        };
        /** @description The PayPal-generated, short-lived, one-time-use token, used to communicate payment information to PayPal for transaction processing. */
        ...
        supplementary_data: {
            ...
            risk?: components["schemas"]["risk_supplementary_data"];
        };
        /**
        ...
        swish_request: {
            ...
            country_code: components["schemas"]["country_code-2"];
            /** @description Customizes the payer experience during the approval process for the payment. */
            experience_context?: components["schemas"]["experience_context_swish"];
        };
        /**
         * Tax Info
        ...
        /**
         * Response of 3D Secure Authentication
        ...
        tracker_item_list: components["schemas"]["tracker_item"][];
        /** @description An array of trackers for a transaction. */
        tracker_list: components["schemas"]["tracker"][];
        /**
         * Tracker Status
